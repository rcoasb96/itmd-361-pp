...
2. Write the name of your group members here: Sarina Stoker and Marko Trajkovikj
...
Write the URL for your personal fork of the repository here: https://github.com/rcoasb96/project3
...
Write the output of `git remote -v` from your copy of the forked repository here:
  ...
  origin  https://github.com/rcoasb96/project3.git (fetch)
  origin  https://github.com/rcoasb96/project3.git (push)
...
Write the URL of your pull request here: https://github.com/itmdproject/project3/pull/1
